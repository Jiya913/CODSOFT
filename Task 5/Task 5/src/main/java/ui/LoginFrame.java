...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        JLabel titleLabel = new JLabel("Login (Password = ID)");
        ...
        usernameField.setBounds(180, 100, 180, 25);
        ...
        loginButton.setBounds(180, 200, 120, 30);
    ...
    private boolean validateLogin(String username, String password) {
        ...
        for (Student student : studentDAO.getAllStudents()) {
            if (student.getName().equals(username) && student.getStudentID().equals(password)) {
                return true;
            }
        }
        return false; 
